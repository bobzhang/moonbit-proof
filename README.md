...
On the current branch, `moon prove` verifies **128 packages** and **958 goals**.

## Examples

The workspace now contains **128 proof packages** spanning branch reasoning,
...
`cauchy25`, `cauchy26`, `cauchy27`, `cauchy28`, `lagrange4sq`,
...
- `cauchy2` through `cauchy28` prove exact Cauchy-Schwarz identities in
  dimensions 2 through 28, not just the final nonnegativity inequality.
- `lagrange4sq` proves Lagrange's four-square identity, i.e. norm
  multiplicativity for quaternion-style multiplication.
- `variance4` through `variance30` prove exact finite-dimensional variance
