...
On the current branch, `moon prove` verifies **116 packages** and **946 goals**.

## Examples

The workspace now contains **116 proof packages** spanning branch reasoning,
...
`cauchy19`, `cauchy20`, `cauchy21`, `cauchy22`,
`lagrange4sq`,
...
- `cauchy2` through `cauchy22` prove exact Cauchy-Schwarz identities in
  dimensions 2 through 22, not just the final nonnegativity inequality.
- `lagrange4sq` proves Lagrange's four-square identity, i.e. norm
  multiplicativity for quaternion-style multiplication.
- `variance4` through `variance24` prove exact finite-dimensional variance
