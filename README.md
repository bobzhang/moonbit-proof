...
On the current branch, `moon prove` verifies **112 packages** and **942 goals**.

## Examples

The workspace now contains **112 proof packages** spanning branch reasoning,
...
`variance20`, `variance21`, `variance22`
...
- `cauchy2` through `cauchy20` prove exact Cauchy-Schwarz identities in
  dimensions 2 through 20, not just the final nonnegativity inequality.
- `lagrange4sq` proves Lagrange's four-square identity, i.e. norm
  multiplicativity for quaternion-style multiplication.
- `variance4` through `variance22` prove exact finite-dimensional variance
