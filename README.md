...
On the current branch, `moon prove` verifies **132 packages** and **962 goals**.

## Examples

The workspace now contains **132 proof packages** spanning branch reasoning,
...
`variance30`, `variance31`, `variance32`
...
- `cauchy2` through `cauchy30` prove exact Cauchy-Schwarz identities in
  dimensions 2 through 30, not just the final nonnegativity inequality.
- `lagrange4sq` proves Lagrange's four-square identity, i.e. norm
  multiplicativity for quaternion-style multiplication.
- `variance4` through `variance32` prove exact finite-dimensional variance
